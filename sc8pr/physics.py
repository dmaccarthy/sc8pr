...
from sc8pr.sketch import Sketch, VISIBLE, HIDDEN, _changeSpin
from sc8pr.geometry import tuple_add, tuple_times, tuple_sub, segments, polar, distance, scalarProduct,\
